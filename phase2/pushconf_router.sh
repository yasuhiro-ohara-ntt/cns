...
lxc file push /tmp/r7.bgpd.conf r7/etc/quagga/bgpd.conf
lxc file push /tmp/r8.bgpd.conf r8/etc/quagga/bgpd.conf
lxc file push /tmp/r9.bgpd.conf r9/etc/quagga/bgpd.conf
...
lxc exec r7 -- systemctl restart quagga
lxc exec r8 -- systemctl restart quagga
lxc exec r9 -- systemctl restart quagga
